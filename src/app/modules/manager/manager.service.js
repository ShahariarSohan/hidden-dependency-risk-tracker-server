...
const getAllManager = async (params, options) => {
...
const softDeleteManager = async (id) => {
    ...
    if (hasAssignedActiveTasks) {
        throw new AppError(httpStatus.BAD_REQUEST, "Manager has assigned tasks in progress. Reassign or complete them first.");
    }

...
const getEmployeeRisk = catchAsync(async (req, res) => {
...
const getSystemRisk = catchAsync(async (req, res) => {
...
const getTeamRisk = catchAsync(async (req, res) => {
...
const getRiskDashboard = catchAsync(async (_req, res) => {
